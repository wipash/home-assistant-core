...
class GenesisEnergyOAuth2Implementation(AuthImplementation):
    """Local OAuth2 implementation for Genesis Energy."""
    ...
    async def async_resolve_external_data(self, external_data: Any) -> dict:
        """Initialize local Genesis Energy auth implementation."""
        data = {
